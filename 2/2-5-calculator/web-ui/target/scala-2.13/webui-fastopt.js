  ...
  return $as_sci_Map(namedExpressions.map__F1__sc_IterableOps(new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function($this, namedExpressions$1) {
    return (function(x$2) {
      ...
      var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function($this$1, x$1, namedExpressions$1$1) {
        return (function() {
          return $m_Lcalculator_Calculator$().eval__Lcalculator_Expr__sci_Map__D($as_Lcalculator_Expr($as_Lcalculator_Signal(x$1.$$und2$f).apply__O()), namedExpressions$1$1)
        })
...
$c_Lcalculator_Calculator$.prototype.eval__Lcalculator_Expr__sci_Map__D = (function(expr, references) {
  _eval: while (true) {
    ...
    if ($is_Lcalculator_Literal(x1)) {
      ...
      if (references.contains__O__Z(x3.name$2)) {
        var temp$expr = $as_Lcalculator_Expr($as_Lcalculator_Signal(references.apply__O__O(x3.name$2)).apply__O());
        var temp$references = $as_sci_Map(references.removed__O__sci_MapOps(x3.name$2));
        expr = temp$expr;
      ...
      var divisor = this.eval__Lcalculator_Expr__sci_Map__D(x4.b$2, references);
      this.eval__Lcalculator_Expr__sci_Map__D(x4.a$2, references);
      if ((divisor !== 0)) {
        return (this.eval__Lcalculator_Expr__sci_Map__D(x4.a$2, references) / divisor)
      } else if ((divisor === 0)) {
        return (NaN)
      } else if ((divisor === (NaN))) {
        return (NaN)
      } else {
        throw new $c_s_MatchError().init___O(divisor)
      }
...
$c_Lcalculator_Polynomial$.prototype.computeSolutions__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal = (function(a, b, c, delta) {
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function($this, delta$1, b$1, a$1, c$1) {
    return (function() {
      ...
      if ((x1 < 0)) {
        ...
        var x1$2 = (((-jsx$1) + $uD($g.Math.sqrt(x))) / ((2 * $uD(a$1.apply__O())) * $uD(c$1.apply__O())));
        var jsx$2 = $uD(b$1.apply__O());
        var x$1 = $uD(delta$1.apply__O());
        var x2 = (((-jsx$2) - $uD($g.Math.sqrt(x$1))) / ((2 * $uD(a$1.apply__O())) * $uD(c$1.apply__O())));
